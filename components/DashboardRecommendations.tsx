        ...
        <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-850 rounded-xl p-4 shadow-sm flex flex-col justify-between overflow-hidden w-full">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-stone-900 dark:text-stone-105">Gợi ý hôm nay</h2>
            </div>
            {collapsed ? (
              ...
              {primaryItems.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    <div>
                      <div className="flex items-center gap-1.5 mb-1.5">
                        <div className="w-5 h-5 rounded flex items-center justify-center bg-stone-100 dark:bg-stone-850 text-stone-700 dark:text-stone-300 transition-transform duration-200 group-hover:scale-110">
                          <Gamepad2 className="w-3 h-3 text-emerald-600 dark:text-emerald-400" />
                        </div>
                        <span className="text-[10px] font-extrabold text-stone-600 dark:text-stone-450 uppercase tracking-wider">
