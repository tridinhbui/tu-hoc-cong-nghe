    ...
    <div className="fixed inset-0 bg-stone-950/85 backdrop-blur-md z-[9999] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 items-center justify-between bg-stone-950/60 border border-stone-800 rounded-2xl p-4 mb-6">
          ...
          {/* Boss Side */}
          <div className="flex flex-col items-center">
            <span className="text-xs font-bold text-amber-400 mb-1">{resolvedBossName}</span>
            <motion.div
        ...
        {battleState === "victory" ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h3 className="text-2xl font-black text-amber-400">{t.bossBattle.victoryTitle}</h3>
          ...
          <div className="text-center py-6 space-y-4">
            ...
            <h3 className="text-2xl font-black text-rose-400">{t.bossBattle.defeatTitle}</h3>
          ...
          <div>
            <div className="flex items-center justify-between text-xs text-stone-400 mb-2 font-bold">
              ...
              <span className="text-amber-400">{format(t.bossBattle.damageLabel, { dmg: dmgPerHit })}</span>
            </div>
