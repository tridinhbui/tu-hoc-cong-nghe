...
export default function TaiTaiQuizSuggestion({ userId, onSelect }: TaiTaiQuizSuggestionProps) {
  ...
  if (!suggestion) {
    return (
      <div className="rounded-2xl border border-line bg-white dark:bg-stone-900 p-4 sm:p-5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1.5">
            <p className="text-sm font-extrabold text-ink">{t.quizSuggestion.suggestionLabel}</p>
          </div>
