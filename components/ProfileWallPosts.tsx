      ...
      {posts.map((post) => (
        ...
        >
          ...
          {post.metadata && typeof post.metadata === "object" && "image_url" in post.metadata && Boolean(post.metadata.image_url) && (
            // Quay lại `<img>` cùng lượt với CommunityFeedClient.tsx - xem chú
            // thích dài ở đó. Tóm tắt: chú thích cũ nói remotePatterns thiếu
            // bucket, điều đó SAI và đã bị bác đúng; nhưng "vậy thì next/image
            // dùng được" là một kết luận KHÁC, và nó chưa từng được kiểm trên
            // một URL ảnh thật. Ảnh chết trên production ngay sau khi đổi.
            <img
