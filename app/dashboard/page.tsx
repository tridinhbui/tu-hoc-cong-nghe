...
const TRACK_PROFESSIONAL = {
  ...
  stages: [
    {
      label: "Chặng 1",
      name: "Nguyên lý & phương trình kế toán",
      days: [21, 25] as [number, number],
      available: true,
    },
    {
      label: "Chặng 2",
      name: "Ghi sổ kép & phân loại tài khoản",
      days: [26, 30] as [number, number],
      available: true,
    },
    {
      label: "Chặng 3",
      name: "Báo cáo tài chính: P&L & Balance Sheet",
      days: [31, 35] as [number, number],
      available: false,
    },
    {
      label: "Chặng 4",
      name: "Lưu chuyển tiền tệ & Điều chỉnh",
      days: [36, 40] as [number, number],
      available: false,
    },
    {
      label: "Chặng 5",
    ...
    {
      label: "Chặng 6",
      name: "Chỉ số tài chính & Định giá",
      days: [61, 80] as [number, number],
      available: false,
    },
    {
      label: "Chặng 7",
      name: "Tài chính doanh nghiệp & Quyết định",
      days: [81, 100] as [number, number],
      available: false,
    },
    {
      label: "Chặng 8",
      name: "Đầu tư & Quản lý rủi ro",
