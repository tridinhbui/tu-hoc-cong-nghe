  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-stone-900 dark:text-stone-100">Quản lý Trò chơi</h1>
          <p className="text-sm text-stone-500 dark:text-stone-400">Theo dõi và quản lý các tính năng game, thành tích người dùng</p>
        </div>
      </div>
