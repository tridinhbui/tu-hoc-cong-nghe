      ...
      <div className="space-y-10 text-stone-700 leading-relaxed text-lg">
        ...
        <section className="space-y-5">
          ...
          <div className="border border-stone-200 rounded-2xl p-6 bg-stone-50 space-y-4">
            <p className="text-xs font-bold text-stone-500 uppercase tracking-widest">So sánh: có và không có đòn bẩy</p>
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-2xl overflow-hidden border border-stone-200 shadow-lg">
            <Image
              src="/lessons/day15-don-bay-tai-chinh.png"
              alt="Tóm tắt trực quan Day 15"
              width={1024}
              height={1536}
        ...
        <div className="text-center space-y-2 py-4">
          <p className="text-stone-500 text-base">Đòn bẩy không tạo ra lợi nhuận từ không khí.</p>
