      ...
      <div className="space-y-10 text-stone-700 leading-relaxed text-lg">
        ...
        <section className="space-y-5">
          ...
          <div className="border border-stone-200 rounded-2xl p-6 bg-stone-50 space-y-4">
            <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Ví dụ so sánh hai lựa chọn</p>
        ...
        <div className="text-center space-y-2 py-4">
          <p className="text-stone-400 text-base">Mọi quyết định tài chính đều là câu hỏi về thời gian.</p>
