      ...
      <div className="space-y-10 text-stone-700 leading-relaxed text-lg">
        ...
        <section className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="border border-stone-200 rounded-2xl p-6 space-y-3">
              <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Ví dụ tài sản</p>
            ...
            <div className="border border-stone-200 rounded-2xl p-6 space-y-3">
              <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Ví dụ tiêu sản</p>
              <ul className="space-y-2 text-stone-600 text-base">
        ...
        <section className="space-y-5">
          ...
          <div className="border border-stone-200 rounded-2xl p-6 bg-stone-50 space-y-3">
            <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Nguyên tắc thực tế</p>
        ...
        <div className="text-center space-y-2 py-4">
          <p className="text-stone-400 text-base">Tài sản bỏ tiền vào túi bạn. Tiêu sản lấy tiền ra.</p>
