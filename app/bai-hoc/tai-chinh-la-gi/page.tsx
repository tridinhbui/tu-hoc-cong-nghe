...
const QUIZ: QuizQuestion[] = [
  ...
  },
  {
    ...
    correct: 1,
    explanation: "Bài học nêu 4 yếu tố cốt lõi để đánh giá một quyết định tài chính: dòng tiền thực tế, giá trị theo thời gian, mức độ rủi ro, và chi phí cơ hội của lựa chọn khác.",
  },
  {
    ...
    correct: 1,
    explanation: "Bài học chỉ rõ: một người thu nhập cao nhưng chi tiêu vượt khả năng và vay nợ quá nhiều có thể có nền tài chính kém hơn người thu nhập vừa phải nhưng quản lý dòng tiền, tiết kiệm và kiểm soát rủi ro tốt.",
  },
  {
    ...
    correct: 1,
    explanation: "Dù là thu nhập cá nhân hay vốn doanh nghiệp, nguồn lực đều có giới hạn còn nhu cầu sử dụng gần như vô hạn - tài chính giúp trả lời nên phân bổ nguồn lực đó thế nào.",
  },
  {
    ...
    correct: 1,
    explanation: "Mở rộng có thể giúp tăng trưởng nhanh hơn nhưng rủi ro cao hơn; giữ tiền mặt an toàn hơn nhưng có thể bỏ lỡ cơ hội sinh lời. Đây chính là chi phí cơ hội trong thực tế.",
  },
  {
    ...
    correct: 1,
    explanation: "Kế toán trả lời 'đã xảy ra gì' (bán bao nhiêu, lãi lỗ ra sao). Tài chính dùng những dữ liệu đó để trả lời 'nên làm gì tiếp theo' - có nên đầu tư, vay thêm, hay không.",
  },
  {
    ...
    correct: 2,
    explanation: "Câu hỏi về thiết kế/màu sắc sản phẩm thuộc về marketing/sản phẩm, không phải câu hỏi tài chính. Tài chính tập trung vào phân bổ nguồn lực, thời gian, rủi ro và chi phí cơ hội.",
  },
  {
    ...
    correct: 1,
    explanation: "Định nghĩa trong bài: tài chính là cách ra quyết định phân bổ nguồn lực có giới hạn theo thời gian và trong điều kiện bất định - trọng tâm là quyết định, không phải chỉ là số dư tài khoản.",
  },
];
