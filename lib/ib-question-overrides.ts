...
export const IB_QUESTION_OVERRIDES: Record<number, IbQuestionOverride> = {
  ...
  313: {
    options: [
      "Assume a price and a cash/stock/debt mix, project both companies' financials, then combine them and divide by the new share count to get pro forma EPS.",
      "Value both companies with a DCF and add the two Enterprise Values together, since the combined figure is what the merged company is worth to its owners.",
      "Assume an entry multiple and a debt package, run the target's cash flows through a debt schedule, and solve for the buyer's IRR at exit.",
      "Combine the two balance sheets, calculate the new debt-to-equity ratio, and use that to determine whether the deal can be financed at all.",
    ],
    correct: 0,
  },
  314: {
    options: [
      "There is a buyer and a seller either way: \"merger\" implies the two are close in size, \"acquisition\" that the buyer is much larger.",
      "In a merger both companies cease to exist and a new entity is formed, whereas in an acquisition the target survives as its own legal entity.",
      "A merger is paid for in stock and an acquisition in cash - the label follows the consideration used rather than the parties' size.",
      "A merger is negotiated with the target's board, while an acquisition bypasses the board and is taken straight to its shareholders.",
    ],
    correct: 0,
  },
  315: {
    options: [
      "To take market share, grow faster than it could organically, buy a target it thinks is undervalued, or capture its customers and technology.",
      "To reduce its tax bill, since the goodwill an acquisition creates is amortised against income for years afterwards.",
      "To raise cash, since consolidating the target lets the buyer draw on that cash balance without issuing new debt.",
      "To cut its own share count, because the shares issued to the seller are retired against the buyer's treasury stock.",
    ],
    correct: 0,
  },
  316: {
    options: [
      "When the Net Income the seller adds doesn't cover the buyer's foregone interest, its new interest expense, and the shares it issued.",
      "When Goodwill created in the deal is amortised against Pre-Tax Income each year, which mechanically reduces the combined EPS.",
      "When the seller's Revenue is added to the buyer's while its Operating Expenses stay behind entirely with the seller's former shareholders.",
      "When the buyer writes the seller's Assets down to book value, and the resulting loss flows through the combined Income Statement.",
    ],
    correct: 0,
  },
  317: {
    options: [
      "Only partly: cash-and-debt deals compare interest cost against the seller's Pre-Tax Income, all-stock deals compare P/E - a mix of all three has no shortcut.",
      "Yes: compare the two companies' EBITDA margins, and the deal is accretive whenever the buyer's margin is the higher of the two.",
      "Yes: any deal struck at a premium below 30% of the seller's share price is accretive, and anything above that is dilutive.",
      "Yes: divide the purchase price by the seller's Net Income, and the deal is accretive whenever that figure comes in under 15x.",
    ],
    correct: 0,
  },
  318: {
    options: [
      "You can't tell without knowing the consideration - the P/E comparison only settles the question in an all-stock deal.",
      "Accretive, because the buyer is buying earnings more cheaply than the market prices its own, whatever the mix of consideration.",
      "Dilutive, because the premium needed to win over the target's shareholders exceeds the gap between the two P/E multiples.",
      "Accretive, since the combined company's P/E settles between the two, lifting the buyer's share price along with its earnings.",
    ],
    correct: 0,
  },
  319: {
    options: [
      "In an all-stock deal a buyer with the higher P/E than the seller gets accretion; a buyer with the lower P/E gets dilution.",
      ...
      "The rule holds for all-cash deals rather than all-stock deals, since cash consideration is what makes the two multiples comparable.",
  ...
  320: {
    options: [
      "Foregone interest on cash, added interest on debt, new shares issued, combined financial statements, and Goodwill and intangibles created.",
      "Foregone interest on cash, added interest on debt, new shares issued, and a step-up of the seller's Assets to their book value.",
      "Combined financial statements, Goodwill created, and a one-time gain equal to the premium the buyer paid over book value.",
      "New shares issued, combined statements, and retirement of the seller's existing debt, which the buyer must repay at close.",
    ],
    correct: 0,
  },
  321: {
    options: [
      "It may want to keep a cash cushion, or its stock may be trading high enough that issuing shares looks the better currency.",
      "Because paying entirely in cash triggers an immediate taxable gain for the buyer on the excess of price over book value.",
      "Because an all-cash deal requires approval from both sets of shareholders, while a stock deal needs only the two boards to sign.",
      "Because cash is the most expensive consideration, since interest forgone on it exceeds the cost of issuing new equity.",
    ],
    correct: 0,
  },
  322: {
    options: [
      "A strategic can realise revenue and cost synergies with its existing business, which raises what the target is worth to it.",
      "A strategic has a lower cost of capital, so the same projected cash flows discount back to a much higher value in its own model.",
      "A strategic holds the target indefinitely rather than exiting in five years, so it has no minimum IRR hurdle to clear.",
      "A strategic can pay in its own stock, and stock costs nothing up front while a PE firm must fund the price in cash.",
    ],
    correct: 0,
  },
  323: {
    options: [
      "They plug the gap between the equity purchase price and the seller's book value - brand, customer relationships and the like.",
      "They record the cash the buyer expects to spend integrating the seller, set aside on the Balance Sheet at closing.",
      "They are the present value of the synergies underwritten in the deal model, capitalised onto the combined Balance Sheet at closing.",
      "They are the premium over the seller's share price the day before announcement, which its shareholders are paid.",
    ],
    correct: 0,
  },
  324: {
    options: [
      "Goodwill isn't amortised and moves only on impairment; Other Intangibles are amortised, which hits Pre-Tax Income.",
      "Goodwill is amortised over a set life while Other Intangibles sit untouched until the buyer sells the division that holds them.",
      "Goodwill arises only in stock deals and Other Intangibles only in cash deals, so the two never sit on one Balance Sheet.",
      "Goodwill is tax-deductible as it amortises, while Other Intangibles are written off in full in the year the deal closes.",
    ],
    correct: 0,
  },
  325: {
    options: [
      "Yes - a write-off of Purchased In-Process R&D, and a write-down of the seller's Deferred Revenue to avoid double-counting.",
      "Yes - the seller's capitalised software is written off in full at closing, since a buyer cannot carry another firm's source code.",
      "No - Goodwill and Other Intangibles are exhaustive, and every other deal adjustment touches only tangible Assets.",
      "Yes - the seller's accumulated deficit carries over as a negative intangible offsetting the Goodwill the deal creates.",
    ],
    correct: 0,
  },
  326: {
    options: [
      "Extra value from combining the two: revenue synergies from cross-selling, cost synergies from cutting redundant staff and sites.",
      "The premium the buyer pays over the target's share price, which is why they are also called the control premium.",
      "The tax savings from combining the two filers, the only category of synergy a merger model actually reflects.",
      "The fall in the combined company's cost of capital that follows from a larger, more diversified earnings base.",
    ],
    correct: 0,
  },
  327: {
    options: [
      "Revenue synergies are added to Revenue at an assumed margin; cost synergies reduce combined COGS or Operating Expenses.",
      "Both are added straight to combined Net Income, since synergies are a post-tax benefit that bypasses the operating lines.",
      "Both are netted against the purchase price, lowering Goodwill and so the amortisation charged to Pre-Tax Income.",
      "Revenue synergies reduce Operating Expenses while cost synergies are added to Revenue - the label names where the benefit lands.",
    ],
    correct: 0,
  },
  328: {
    options: [
      "Cost synergies - consolidating sites and cutting duplicated roles is far easier to underwrite than predicting new sales.",
      "Revenue synergies - they compound with growth, whereas a cost saving is a one-off that disappears after the first full year.",
      "They carry equal weight, since a merger model applies the same probability haircut to both before either reaches EPS.",
      "Revenue synergies - buyers underwrite them first, as they are the only kind credit committees will lend against.",
    ],
    correct: 0,
  },
  329: {
    options: [
      "Cash - interest forgone is usually below the rate on new debt, and it avoids both financing risk and share-price risk.",
      "Stock - issuing shares costs nothing in cash and lets the seller's holders share the risk that synergies fall short.",
      "Debt - interest is tax-deductible, which makes debt the cheapest of the three wherever interest rates happen to sit.",
      "Debt - it leaves the cash balance intact and avoids dilution, so it is the one method that cannot reduce the combined EPS.",
    ],
    correct: 0,
  },
  330: {
    options: [
      "Take the median Debt/EBITDA from comparable companies and precedent deals, and apply it to the combined company's LTM EBITDA.",
      "Take the combined company's total Assets and apply the industry median Debt/Assets, since lenders secure against Assets.",
      "Issue debt until combined interest expense equals the seller's Pre-Tax Income, the point where accretion breaks even.",
      "Match the buyer's existing debt balance, since lenders will not let a borrower double its outstanding leverage at once.",
    ],
    correct: 0,
  },
  331: {
    options: [
      "The usual valuation methodologies, plus - for a public seller - a premium over the current share price, typically 15-30%.",
      "The seller's book value plus the Goodwill the buyer expects to record, since that sum is what the combined Balance Sheet absorbs.",
      "Whatever price still leaves the deal accretive in year one, since no board approves a transaction that dilutes its EPS.",
      "The seller's undisturbed share price, since paying a premium hands the entire value of the synergies to the other side.",
    ],
    correct: 0,
  },
  332: {
    options: [
      "A large Goodwill balance is created, and the buyer often takes a goodwill impairment charge later - eBay and Skype, say.",
      "The excess over fair value is expensed immediately at closing, so the buyer absorbs the whole overpayment in one quarter.",
      "The purchase price is retroactively adjusted through an earn-out, which is why almost every overpriced deal carries one.",
      "The buyer records negative Goodwill, which is amortised back into income and flatters earnings for several years.",
    ],
    correct: 0,
  },
  333: {
    options: [
      "The buyer's share price falls by the per-share equivalent of the $50 million, and the seller effectively receives half.",
      "The buyer's share price halves, since the market re-rates the whole combined entity in the same proportion as the target.",
      "Nothing changes for the seller - the exchange ratio was fixed at signing, so its holders keep the agreed dollar value.",
      "The buyer must issue more shares to top the seller up to $100 million, which deepens the dilution to its own holders.",
    ],
    correct: 0,
  },
  334: {
    options: [
      "Integration is hard, the underwritten synergies rarely arrive, and many deals are driven by ego rather than by strategy.",
      "Because buyers almost always finance with debt, and the added interest expense alone sinks the combined company.",
      "Because regulators block most announced deals, leaving buyers with break fees and no acquisition to show for it.",
      "Because year-one accretion is nearly always followed by dilution once the Goodwill amortisation begins.",
    ],
    correct: 0,
  },
  335: {
    options: [
      "It is a sanity check on assumptions - no deal is decided on a model's output; ego and personalities matter more.",
      "It sets the purchase price: the offer is the price at which the model shows accretion turning to dilution in year one.",
      "It is the document both boards sign off on, so its accretion figure becomes a covenant the buyer has to deliver.",
      "It is built mainly for the financing banks, which size the debt package off the model's projected combined EBITDA.",
    ],
    correct: 0,
  },
  336: {
    options: [
      "Purchase price, the cash/stock/debt mix, and revenue and cost synergies - usually run against EPS accretion or dilution.",
      "The discount rate and terminal growth rate, the two assumptions that move the combined company's implied equity value the most.",
      "Entry and exit multiples, since the spread between them drives the return the buyer earns on the deal over time.",
      "Revenue growth and EBITDA margin, which are almost always run as sensitivities rather than built in as scenarios.",
    ],
    correct: 0,
  },
  ...
  337: {
    options: [
      "Purchase accounting wipes out the seller's equity and books the premium as Goodwill; pooling simply adds the two equity balances.",
      "Under pooling the seller's equity is wiped out and Goodwill is created; under purchase accounting the two equity balances are combined.",
      "The two produce identical balance sheets and differ only in how the transaction is disclosed in the footnotes to the accounts.",
  ...
  338: {
    options: [
      "Take the revenue-per-search uplift under the buyer's monetisation, multiply by the target's search volume, then apply a margin.",
      "Take the combined revenue of both companies and apply an assumed synergy percentage, typically 5-10%, to arrive at the uplift figure.",
      "Add the two companies' revenues together and apply the buyer's operating margin, since the margin gap is where the synergy sits.",
  ...
  339: {
    options: [
      "Count the overlapping SG&A roles the buyer will cut - 800 of the target's 1,000 - and multiply by average fully loaded salary.",
      "Take the combined SG&A of both companies and reduce it by a standard 20%, the accepted benchmark for expense synergies in a model.",
      ...
      "Take the gap between the two companies' EBITDA margins and apply that spread to the combined company's revenue base.",
    ],
    correct: 0,
  },
  340: {
    options: [
      "Apply Section 382: allowable NOLs per year = equity purchase price × the highest adjusted long-term rate of the past three months.",
      "The buyer inherits the full NOL balance and may use all of it in year one to offset the combined company's taxable income.",
      "Apply Section 382: allowable NOLs per year = the seller's NOL balance × the long-term rate, giving $12.5 million a year here.",
      "NOLs are extinguished on a change of control, so none of the balance carries over to the buyer in any deal structure.",
    ],
    correct: 0,
  },
  341: {
    options: [
      "A write-up creates a Deferred Tax Liability and a write-down a Deferred Tax Asset - book basis moves, tax basis doesn't.",
      ...
      "They arise from the difference between the purchase price and the target's market capitalisation on the announcement date.",
      "They arise only when the buyer and the seller are taxed in different jurisdictions and the two rates have to be reconciled.",
    ],
    correct: 0,
  },
  342: {
    options: [
      "DTA = asset write-down × tax rate and DTL = asset write-up × tax rate; both feed the Goodwill plug on the pro-forma balance sheet.",
      "They feed the Goodwill plug on the pro-forma balance sheet, with DTA = asset write-up × tax rate and DTL = write-down × rate.",
      "They are recorded on the income statement at closing rather than the balance sheet, so they never affect the Goodwill figure.",
      "They offset each other exactly in most transactions, so the net effect on the balance sheet adjustment washes out to nil.",
    ],
    correct: 0,
  },
  343: {
    options: [
      "No - in an asset purchase the book basis of the assets always matches the tax basis, so no timing difference arises.",
      ...
      "Yes, but only Deferred Tax Assets, since an asset purchase can write assets down but never step their basis up.",
    ],
    correct: 0,
  },
  344: {
    options: [
      "Build a book vs. cash tax schedule; the gap between book and cash taxes each year flows through the DTL balance.",
  ...
  345: {
    options: [
      ...
      "Goodwill = equity purchase price - seller book value + asset write-ups + seller's existing DTL, since write-ups add to the premium paid.",
      "Goodwill = equity purchase price - seller book value, with existing goodwill and deferred tax balances having no bearing at all.",
      "Goodwill = enterprise purchase price - seller total assets + seller total liabilities - asset write-ups + newly created DTA balance.",
    ],
    correct: 0,
  },
  346: {
    options: [
      "Because DTAs include NOLs, and the portion you cannot use post-transaction has to come off the balance sheet.",
      "Because the seller's DTA is an intangible asset, and every intangible is written down to zero at the closing date.",
  ...
  347: {
    options: [
      "Legally a stock purchase but taxed as an asset purchase: the seller is still double-taxed, while the buyer gets a stepped-up basis.",
      "It converts an asset purchase into a stock purchase for tax purposes, letting the seller avoid double taxation entirely.",
      "It lets the buyer acquire only selected assets and liabilities while still receiving the target's NOL balance in full.",
  ...
  348: {
    options: [
      "It fixes how many buyer shares each seller share converts into - say 1.5 - rather than fixing a dollar value.",
  ...
  349: {
    options: [
      "Purchase price, form of consideration, transaction structure, treatment of options, reps and warranties, and the no-shop.",
  ...
  350: {
    options: [
      "A deferred payment contingent on the target hitting agreed goals after closing, bridging a valuation gap.",
      "A payment the seller must make back to the buyer if the target misses its financial targets after closing.",
  ...
  351: {
    options: [
      "Same mechanics, but the structure is more likely an asset purchase or 338(h)(10), and a private seller has no EPS.",
      "It can't be done - accretion/dilution requires both companies to have a listed share price and a reported EPS.",
  ...
  352: {
    options: [
      "Set EPS accretion/dilution to exactly zero and back-solve for the level of synergies required to get there.",
      "Add the revenue and cost synergies together and divide by the purchase price, giving the synergy yield on the deal.",
      "Calculate the synergies needed to cover the premium paid over the target's undisturbed price at announcement.",
  ...
  353: {
    options: [
      "Combine the income statements, then the balance sheets excluding the seller's equity, make the pro-forma adjustments, and project forward.",
      "Combine all three statements line by line including the seller's shareholders' equity, and let the cash balance plug any difference.",
  ...
  354: {
    options: [
      "It depends on the Purchase Agreement - the buyer may assume them, or the seller may cash them out above the strike price.",
      "They are cancelled at closing without payment, since the target's securities cease to exist once the acquisition completes.",
      "They are cashed out at full face value regardless of exercise price, and the cost is added on to the purchase price.",
      "They are ignored in a merger model, because dilutive securities affect only the target's standalone equity valuation.",
    ],
    correct: 0,
  },
  355: {
    options: [
      "Stock purchase, asset purchase, and a 338(h)(10) election - they differ in what transfers, how the seller is taxed, and whether the basis steps up.",
      "Cash purchase, stock purchase, and debt-financed purchase - the three structures are defined by the form of consideration used.",
      "Merger, tender offer, and hostile takeover, the three routes by which a buyer can acquire control of another company.",
  ...
  356: {
    options: [
      "The seller prefers a stock purchase to avoid double taxation; the buyer prefers an asset purchase for the stepped-up basis.",
      "Both prefer a stock purchase, which is why it accounts for the overwhelming majority of deals done in practice.",
  ...
  357: {
    options: [
      "It compares how much revenue, EBITDA and cash each side brings, to gauge what the ownership split should be.",
      "It compares the synergies each side is expected to contribute, to determine how those benefits should be shared.",
      "It measures how much each of the two companies contributed to the sector's overall growth over five years.",
      "It allocates the purchase price across the target's divisions in proportion to the earnings each one generates.",
    ],
    correct: 0,
  },
  358: {
    options: [
      "Expense transaction and miscellaneous fees upfront, but capitalise financing fees over the life of the debt.",
      "You capitalise all of them and amortise over the life of the debt, which is the treatment current standards require.",
      "You expense all of them upfront, since none of these costs creates any future economic benefit for the buyer.",
