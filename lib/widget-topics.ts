...
export const WIDGET_TOPIC_TERMS: Record<string, string[]> = {
  ...
  roe: ["roe", "roa", "roic", "vốn chủ", "dupont", "sinh lời", "lợi nhuận trên"],
  "cash-flow-simulator": ["dòng tiền", "cash flow", "thanh khoản", "vốn lưu động", "ccc", "conversion cycle", "hoà vốn", "đốt tiền", "hoàn vốn", "ltv", "cac", "payback"],
  ...
  "macro-policy": ["chính sách", "lạm phát", "gdp", "tiền tệ", "tài khóa", "vĩ mô", "kinh tế"],
  ...
  "liquidity-run": ["thanh khoản", "rút tiền", "liquidity", "dòng tiền ra", "sống sót", "bù trừ", "tài sản bảo đảm", "ký quỹ", "netting"],
  ...
  "tax-brackets": ["thuế", "tncn", "bậc", "luỹ tiến", "lũy tiến", "giảm trừ", "bhxh", "bhyt", "quyết toán", "hoàn thuế", "thu nhập"],
