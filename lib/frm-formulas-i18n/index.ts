...
import type { FrmFormulaItem } from "@/lib/frm-formulas-data";
import { frmFormulasEn } from "./en";

/**
 * Bản dịch 92 công thức FRM trong lib/frm-formulas-data.ts.
 *
 * Cùng khuôn lib/finance-careers-i18n và lib/cfa-glossary-i18n: lớp phủ khoá
...
export function mergeFormula(item: FrmFormulaItem, locale: Locale): FrmFormulaItem {
...
export function mergeFormulas(items: FrmFormulaItem[], locale: Locale): FrmFormulaItem[] {
