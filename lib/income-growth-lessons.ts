...
export const INCOME_GROWTH_LESSONS: Lesson[] = [
  ...
  {
    id: 307,
    slug: "thu-nhap-tu-san-pham-phu",
    title: "Chặng 11, Bài 8: Thu nhập từ sản phẩm phụ - cái nào thật, cái nào là quảng cáo",
    subtitle: "Thứ thật sự chạy không cần bạn thì thu về khiêm tốn; thứ hứa nhiều thì luôn có người phải làm việc",
    duration: "8 phút",
    difficulty: "Trung bình",
    emoji: "🛒",
    track: "personal",
    whyItMatters:
      "Ý tưởng viết một thứ rồi nó tự kiếm tiền được bán lại cho lập trình viên nhiều hơn bất kỳ nghề nào khác. Phần lớn những thứ được đem ra làm ví dụ đều cần công đều đặn, và công đó chỉ không xuất hiện trong câu chuyện chứ không phải không tồn tại.",
    openingQuestion: "Câu hỏi nào phân loại nhanh nhất một nguồn thu là thật sự tự chạy hay không?",
    openingOptions: [
      "Nếu bạn biến mất ba tháng thì nó còn chạy không",
      "Nguồn đó có đòi bỏ vốn ban đầu không",
      "Số tiền thu về mỗi tháng có ổn định qua các tháng khác nhau trong năm không",
      "Bạn có phải trực tiếp làm việc với khách hàng hoặc người dùng cuối hay không",
    ],
    correctOption: 0,
    explanation:
      "Phép thử ba tháng cắt qua mọi cách gọi tên. Một thư viện có người tài trợ vẫn cần bạn trả lời vấn đề và nâng phiên bản; ngừng ba tháng thì người tài trợ rời đi. Một khoá học quay sẵn thì chạy được lâu hơn, nhưng nội dung kỹ thuật cũ đi và doanh thu giảm dần. Một mẫu giao diện bán trên chợ thì gần với tự chạy nhất, và thu về cũng khiêm tốn nhất. Đây không phải sự trùng hợp: mức độ tự chạy và mức thu về gần như luôn đánh đổi nhau, vì phần thu cao đến từ chính phần việc mà ai đó phải làm. Khi một lời chào mời cho bạn cả hai cùng lúc, phần việc ấy vẫn tồn tại - nó chỉ đang được làm bởi người khác hoặc chưa được kể ra.",
    diagram: [
      { label: "Hỏi: biến mất ba tháng thì còn chạy không", arrow: true },
      { label: "Còn chạy nhưng giảm dần: bán dữ liệu, mẫu, khoá quay sẵn", arrow: true },
      { label: "Dừng hẳn: tư vấn, hỗ trợ, dịch vụ có người dùng", arrow: true },
      { label: "Mức tự chạy càng cao thì thu về càng khiêm tốn" },
    ],
    realWorldExample: {
      company: "Thư viện có người tài trợ",
      description:
        "Một lập trình viên viết một thư viện được nhiều dự án dùng và bắt đầu có người tài trợ hằng tháng. Con số nghe như thu nhập tự chạy. Thực tế mỗi tuần vẫn có vấn đề cần trả lời, mỗi quý có một đợt nâng phiên bản, và khi bạn ấy bận ba tháng thì số người tài trợ giảm quá nửa. Nguồn thu ấy có thật; phần tự chạy thì không.",
    },
    quiz: [
      {
        question: "Vì sao nguồn thật sự tự chạy thường thu về khiêm tốn?",
        options: [
          "Vì phần thu cao đến từ chính phần việc mà ai đó phải làm",
          "Vì các nguồn tự chạy thường nhắm tới thị trường nhỏ nên tổng cầu bị giới hạn từ đầu",
          "Vì cạnh tranh lớn nên giá bị đẩy xuống",
          "Vì người mua thường không sẵn sàng trả cao cho sản phẩm không có hỗ trợ đi kèm",
        ],
        correct: 0,
        explanation:
          "Đây là quan hệ đánh đổi chứ không phải một đặc điểm riêng của thị trường nào. Phần giá trị mà người mua trả cao nằm ở việc có người xử lý trường hợp của họ, và đó đúng là phần không tự chạy được. Bỏ phần đó đi thì sản phẩm rẻ hơn, và bán được nhiều cũng khó bù lại.",
      },
      {
        question: "Nhóm sản phẩm nào gần với tự chạy nhất?",
        options: [
          "Mẫu, tài sản số hoặc bộ dữ liệu bán một lần, không hỗ trợ",
          "Ứng dụng thu thuê bao hằng tháng",
          "Khoá học quay sẵn, bán lại nhiều lần",
          "Thư viện mã nguồn mở có người tài trợ",
        ],
        correct: 0,
        explanation:
          "Ba nhóm kia đều có một dây nối về phía bạn: thuê bao cần dịch vụ chạy và có người hỗ trợ, khoá học cần nội dung còn đúng, thư viện cần được nâng phiên bản. Bán một lần không kèm hỗ trợ thì cắt hẳn dây đó - và thu về cũng phản ánh đúng điều ấy.",
      },
      {
        question: "Khoá học kỹ thuật quay sẵn có đặc điểm gì đáng lưu ý về lâu dài?",
        options: [
          "Nội dung cũ đi theo công nghệ, nên doanh thu giảm dần nếu không quay lại",
          "Người quan tâm đã mua hết từ đợt đầu",
          "Nền tảng bán khoá tăng dần tỷ lệ ăn chia",
          "Học viên cũ đòi được cập nhật miễn phí",
        ],
        correct: 0,
        explanation:
          "Đây là khoản bảo trì đội lốt thu nhập tự chạy. Một khoá về công nghệ đang đổi nhanh mất giá trị trong một tới hai năm, nên giữ doanh thu nghĩa là quay lại phần lớn nội dung theo chu kỳ - tức là một công việc định kỳ, chỉ khác là nó không có ai giao cho bạn.",
      },
      {
        question: "Một lời mời hứa thu nhập cao mà không cần làm gì nên được đọc thế nào?",
        options: [
          "Hỏi ai đang làm phần việc tạo ra khoản thu đó",
          "Kiểm tra xem những người đã tham gia trước đó có nhận được tiền như cam kết không",
          "So sánh mức thu hứa hẹn với mức trung bình của các cơ hội tương tự trên thị trường",
          "Yêu cầu bên mời cung cấp số liệu chứng minh về kết quả trong thời gian vừa qua",
        ],
        correct: 0,
        explanation:
          "Câu này cắt qua mọi lớp trình bày, vì tiền không tự sinh ra: hoặc có người đang làm việc, hoặc khoản thu đến từ chính tiền của người tham gia sau. Ba cách kiểm kia đều dựa vào thông tin do bên mời cung cấp, nên chúng kiểm được sự nhất quán chứ không kiểm được nguồn gốc.",
      },
      {
        question: "Vì sao nên tính thu về trên số giờ đã bỏ ra thay vì nhìn con số mỗi tháng?",
        options: [
          "Vì con số mỗi tháng giấu mất phần công đã bỏ ra để dựng và phần công đang duy trì",
          "Vì thu nhập theo tháng thường biến động nên cần một khoảng thời gian dài hơn để đánh giá",
          "Vì cần so sánh được với mức thu nhập từ công việc chính để biết có nên tiếp tục không",
          "Vì các khoản chi phí vận hành thường không được tính vào con số thu về hằng tháng",
        ],
        correct: 0,
        explanation:
          "Một nguồn mang về vài triệu mỗi tháng nghe hấp dẫn cho tới khi cộng cả trăm giờ đã bỏ ra để dựng và mười giờ mỗi tháng đang bỏ ra để duy trì. Phép chia đó thường cho ra một con số thấp hơn mức bạn nhận được cho cùng số giờ ở công việc chính - và đó là thông tin đáng biết trước khi mở rộng.",
      },
    ],
    practicePrompt: {
      question:
        "Bạn định bán một bộ mẫu giao diện và một khoá học về cùng chủ đề. Nên bắt đầu bằng cái nào?",
      options: [
        "Bộ mẫu, vì nó kiểm được nhu cầu với ít công hơn nhiều",
        "Khoá học, vì nó mang lại doanh thu trên mỗi người mua cao hơn hẳn so với bộ mẫu",
        "Cả hai cùng lúc để tận dụng chung phần nội dung đã chuẩn bị và tiếp cận rộng hơn",
        "Khoá học trước để xây dựng uy tín rồi mới bán bộ mẫu cho chính nhóm học viên đó",
      ],
      correct: 0,
      explanation:
        "Bộ mẫu tốn ít công hơn nhiều lần và trả lời đúng câu hỏi quan trọng nhất là có ai trả tiền cho chủ đề này không. Nếu câu trả lời là không thì bạn biết sau vài tuần thay vì sau vài tháng quay khoá học - và nếu là có thì khoá học vẫn còn nguyên đó để làm.",
    },
    keyTakeaways: [
      "Phép thử: biến mất ba tháng thì nó còn chạy không",
      "Mức tự chạy và mức thu về gần như luôn đánh đổi nhau",
      "Khoá học quay sẵn là bảo trì định kỳ đội lốt thu nhập tự chạy",
      "Hứa cả thu cao lẫn không phải làm gì thì hỏi ai đang làm phần việc đó",
    ],
    summary: {
      keyIdea: "Không có nguồn thu nào tự chạy mà thu cao; phần thu cao chính là phần ai đó phải làm",
      commonMistake: "Nhìn con số mỗi tháng mà không chia cho tổng số giờ đã dựng và đang duy trì",
      action: "Với mỗi nguồn thu phụ, trả lời hai câu: biến mất ba tháng thì sao, và thu về trên mỗi giờ là bao nhiêu.",
    },
    application: {
      title: "Hai phép tính, mười phút",
      message:
        "Với nguồn thu phụ bạn đang có hoặc đang cân nhắc: nếu ngừng hẳn ba tháng thì còn lại bao nhiêu phần, và tổng thu chia cho tổng giờ đã bỏ ra bằng bao nhiêu.",
      secondary:
        "So con số thứ hai với mức bạn nhận cho cùng số giờ ở việc chính - đó là phép so mà các câu chuyện thành công không bao giờ đưa ra.",
    },
    sections: [
      {
        type: "lead",
        text: "Ít nghề nào được chào mời ý tưởng viết một thứ rồi nó tự kiếm tiền nhiều như nghề lập trình. Phần lớn ví dụ được đem ra đều có một phần công đều đặn, và phần đó chỉ vắng mặt trong câu chuyện.",
      },
      {
        type: "heading",
        text: "Phép thử ba tháng",
      },
      {
        type: "conceptTable",
        title: "Bốn nhóm, xếp theo mức tự chạy",
        concepts: [
          {
            vi: "Bán một lần, không hỗ trợ",
            en: "One-off assets",
            def: "Mẫu, tài sản số, bộ dữ liệu. Gần tự chạy nhất, và thu về cũng khiêm tốn nhất.",
          },
          {
            vi: "Khoá học quay sẵn",
            en: "Recorded courses",
            def: "Chạy được một hai năm rồi nội dung cũ đi. Giữ doanh thu nghĩa là quay lại theo chu kỳ.",
          },
          {
            vi: "Thư viện có tài trợ",
            en: "Sponsored library",
            def: "Cần trả lời vấn đề và nâng phiên bản. Ngừng vài tháng thì người tài trợ rời đi.",
          },
          {
            vi: "Dịch vụ có người dùng",
            en: "Running service",
            def: "Thu cao nhất và tự chạy ít nhất. Đây là một công việc, chỉ khác là bạn tự giao cho mình.",
          },
        ],
      },
      {
        type: "paragraph",
        text: "Bảng trên xếp theo một trục duy nhất, và nó cũng chính là trục xếp mức thu về, chỉ theo chiều ngược lại. Đó không phải sự trùng hợp: người mua trả cao khi có ai đó xử lý trường hợp cụ thể của họ, và việc xử lý ấy đúng là phần không tự chạy được. Chọn ở đây không phải chọn cái tốt hơn mà là chọn mình muốn đổi gì lấy gì.",
      },
      {
        type: "callout",
        label: "Hứa cả hai cùng lúc thì phần việc vẫn ở đâu đó",
        text: "Khi một lời chào mời cho bạn vừa thu cao vừa không phải làm gì, phần việc tạo ra khoản thu ấy không biến mất - nó đang được làm bởi người khác, hoặc khoản thu đến từ chính tiền của những người tham gia sau. Câu hỏi ai đang làm phần việc đó cắt qua mọi cách trình bày, và nó trả lời được mà không cần số liệu nào từ bên mời.",
      },
      {
        type: "closing",
        lines: [
          "Không có nguồn thu nào vừa tự chạy vừa thu cao; chỉ có việc chọn đổi cái nào lấy cái nào.",
          "Bài sau: bỏ tiền và thời gian vào chính mình thì cái nào có kết quả đo được.",
        ],
      },
    ],
  },
