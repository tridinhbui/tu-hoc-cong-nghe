...
export const avatarOptionsVi = {
  ...
  avatarOptions: {
    ...
    outfitColors: {
      "navy-suit": "Navy Wall Street",
      "midnight-black": "Đen Đêm Phố Wall",
      "emerald-wealth": "Xanh Ngọc Bảo Vốn",
      "royal-blue": "Xanh Hoàng Gia",
      "deep-purple": "Tím Huyền Thoại M&A",
    ...
    beards: {
      ...
      "gentleman-mustache": "Râu Mép Phố Wall",
      "full-beard": "Râu Quai Nón Rậm",
      "goatee": "Râu Dê Chuyên Gia",
    } as Record<string, string>,
    outfitStyles: {
      "wall-st-suit": "Bộ Suit Wall Street Premium",
    ...
    accessories: {
      ...
      "trophy-cup": "Cúp Vô Địch NYSE",
      "coffee-cup": "Tách Cà Phê Bloomberg",
    } as Record<string, string>,
    backgrounds: {
      "wallstreet-trading-floor": "Sàn Giao Dịch NYSE Wall Street",
...
export const avatarOptionsEn: typeof avatarOptionsVi = {
  ...
  avatarOptions: {
    ...
    outfitColors: {
      "navy-suit": "Wall Street Navy",
      "midnight-black": "Wall Street Midnight",
      "emerald-wealth": "Capital Emerald",
      "royal-blue": "Royal Blue",
      "deep-purple": "M&A Legend Purple",
    ...
    beards: {
      ...
      "gentleman-mustache": "Wall Street Moustache",
      "full-beard": "Full Beard",
      "goatee": "Expert's Goatee",
    } as Record<string, string>,
    outfitStyles: {
      "wall-st-suit": "Wall Street Premium Suit",
    ...
    accessories: {
      ...
      "trophy-cup": "NYSE Champion's Trophy",
      "coffee-cup": "Bloomberg Coffee Cup",
    } as Record<string, string>,
    backgrounds: {
      "wallstreet-trading-floor": "NYSE Trading Floor",
