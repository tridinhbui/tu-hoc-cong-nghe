...
export const finalTwoVi = {
  finalTwo: {
    ...
    cfaCampaign: {
      missionLabel: "Nhiệm vụ hiện tại",
      continueCta: "Học tiếp",
      allDone: "Đã đi hết mười môn Level I",
      readinessLabel: "Sẵn sàng thi",
      readinessHint: "Cân theo trọng số chính thức của CFA Institute, không phải đếm bài",
      levelProgress: "{done}/{total} bài Level I",
      xpEarned: "{xp} XP đã kiếm",
      milestone: "Còn {lessons} bài {subject} → +{xp} XP → mở {unlocks}",
      milestoneLast: "Còn {lessons} bài {subject} → +{xp} XP",
      pathLabel: "Lộ trình mười môn",
      stateUpcoming: "Chưa tới lượt",
      stateOpen: "Sẵn sàng",
      stateInProgress: "Đang học",
      stateProficient: "Đã nắm",
      stateMastered: "Trọn môn",
      weightLabel: "Trọng số đề thi {weight}",
      toolsLabel: "Công cụ ôn tập",
      toolRecommended: "Nên dùng bây giờ",
      toolAvailable: "Dùng được",
      flashcards: "Thẻ ghi nhớ",
      flashcardsHint: "Thuật ngữ CFA, lặp ngắt quãng",
      cheatSheet: "Bảng công thức",
...
export const finalTwoEn: typeof finalTwoVi = {
  finalTwo: {
    ...
    cfaCampaign: {
      ...
      allDone: "All ten Level I subjects covered",
      readinessLabel: "Exam readiness",
      readinessHint: "Weighted by the official CFA Institute blueprint, not a lesson count",
      levelProgress: "{done}/{total} Level I lessons",
      xpEarned: "{xp} XP earned",
      milestone: "{lessons} {subject} lessons left → +{xp} XP → unlocks {unlocks}",
      milestoneLast: "{lessons} {subject} lessons left → +{xp} XP",
      pathLabel: "The ten-subject path",
      stateUpcoming: "Not yet",
      stateOpen: "Ready",
      stateInProgress: "In progress",
      stateProficient: "Solid",
      stateMastered: "Complete",
      weightLabel: "Exam weight {weight}",
      toolsLabel: "Study tools",
      toolRecommended: "Recommended now",
      toolAvailable: "Available",
      flashcards: "Flashcards",
      flashcardsHint: "CFA terms, spaced repetition",
      cheatSheet: "Formula sheet",
