...
export const en: Dictionary = {
  ...
  emails: {
    ...
    digestLessons: "<b>{count}</b> lessons completed",
    digestXp: "<b>{count}</b> XP earned",
    digestStreak: "Current streak: <b>{days} days</b> (record: {record} days)",
    digestKeepGoing: "Keep it up!",
    digestNoActivity:
      "You haven't studied at all this week - your current streak is <b>{days} days</b>. Come back and keep it going!",
    fallbackName: "there",
    fallbackMember: "A member",
    fallbackLearner: "A learner",
    streakAtRiskSubject: "Don't lose your study streak!",
    streakAtRiskBody: "Your study streak is about to break if you don't study today. Come back now!",
    streakAtRiskEmail: "Hi {name}, your study streak is about to break if you don't study today. Come back now!",
    comebackEmail: "Hi {name}, you haven't done a new lesson in a few days. Come back and pick up your path!",
    comebackSubject: "It's been a while since you studied finance",
    comebackBody: "You haven't done a new lesson in a few days. Come back and pick up your path!",
  ...
  worldBoss: {
    ...
    rulesTitle: "Rules & how the server boss hunt works:",
  ...
  worldMap: {
    ...
    tickerCase: "TIMES SQUARE: CASE STUDY #12 ACTIVE",
    ...
    dragHintLong: "Drag the canvas freely, 360° • see all 12 territories",
  ...
  ecosystem: {
    ...
    deskLabel: "3D DESK · PERSONAL FINANCE",
    cheerLabel: "Cheer:",
  ...
  guild: {
    stopLossTitle: "Stop-Loss Discipline Lesson ({ticker} {percent}%)",
    stopLossDesc:
    ...
    concentrationTitle: "Concentration Risk warning",
    concentrationDesc:
  ...
  feed: {
    ...
    rankSub: "Top XP this week",
    rankEmpty: "Nobody on the board yet.",
    rankViewAll: "See the full board",
    rankXpUnit: "XP",
  ...
  resume: {
    ...
    minutesStudied: "{minutes} minutes studied",
  ...
  topics: {
    ...
    "vn-stock-practical": "Vietnamese stock market in practice",
    "digital-assets-risk": "Digital assets & their risks",
    "fraud-safety": "Fraud protection & safety",
    "real-estate-vn": "Vietnamese real estate",
    "life-expenses": "Life's big expenses",
    "health-risk": "Health and human risk",
    "life-stage": "Finance by life stage",
    "personal-ops": "Tools and operations",
  ...
  caseArena: {
    ...
    hubTitle: "Times Square financial hub",
  ...
  adminChat: {
    ...
    adminName: "Admin",
    recalledToast: "Message recalled.",
  },
