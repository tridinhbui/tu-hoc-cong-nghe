...
export const en: Dictionary = {
  ...
  ecosystem: {
    ...
    stage1: "Stage 1",
    stage1Title: "Programming basics & the command line",
    stage1Status: "100% complete",
    stage2: "Stage 2",
    stage2Title: "Reading code & analysing performance",
    stage2Status: "In progress (80%)",
    stage3: "Stage 3",
    stage3Title: "System design & service architecture",
    stage3Status: "Locked (pass stage 2 first)",

    samplerLabel: "ACTIVE RECALL SAMPLER",
    samplerCounter: "Question 1/1",
    samplerQuestion:
      "An endpoint has an excellent p50 but a p99 thirty times higher. What is the most common cause?",
    ...
    post1Topic: "Performance analysis",
    post1Title: "How to read a stack trace quickly, in 5 minutes",
    post1Content:
      "People new to programming often skip the stack trace and read only the last error line. Remember the rule: the last line says where it fell over, but the frames above say how it got there.",
    post2Time: "4 hours ago",
    post2Topic: "Tech foundations",
    post2Title: "Does the 20/60/20 split of an engineer's time still hold up?",
    post2Content:
      "20% reading other people's code - 60% writing and fixing - 20% learning something new. When urgent work piles up, fix the 20% learning first, because it is the first thing cut and the slowest to win back.",
  },
  ...
  guild: {
    ...
    concentrationDesc:
      "You have more than 80% of your portfolio value in a single company. The lesson: diversification cuts the risk specific to one company - the same way putting all your infrastructure in one provider region does.",
    ...
    universe: "The top 30 technology companies",
    subtitle: "A technology-sector fund simulator",
