...
export const en: Dictionary = {
  ...
  emails: {
    ...
    comebackSubject: "It's been a while since you studied tech",
  ...
  tracks: {
    ...
    professional: {
      tab: "Advanced technology",
      subtitle: "In depth, for those who can already code",
      description:
        "System architecture, databases at scale, infrastructure and operations, data, and AI in real products.",
      stages: [
        "Data structures, algorithms and complexity",
        "System design and service architecture",
        "Databases: modelling, indexing and performance",
        "Infrastructure, containers and running a product",
        "Data: pipelines, warehouses and analytics",
        "AI in products: LLMs, RAG and evaluating quality",
      ],
    ...
    cfa: {
      ...
      description:
        "Maps the existing lessons onto the four official AWS Solutions Architect Associate domains - no new lessons, and no change to the day counts of the other two tracks. Domains with no suitable lesson yet are being built out.",
      stages: [
      ...
      previewLabel: "See the AWS Solutions Architect track",
    },
  },
  ...
  home: {
    banner: {
      ...
      part2:
        ", for the sake of the community learning programming, data, AI, and everyone working in tech in Vietnam.",
    ...
    hero: {
      ...
      sub: "{count}+ lessons - 100% free forever - a curriculum built specifically for Vietnamese learners covering programming, data, AI, infrastructure and the craft of building tech products. Taught with scientifically grounded spaced repetition.",
      ctaPrimary: "Start learning free",
      ctaSecondary: "Try a lesson",
      bgAlt: "A modern technology setting",
    ...
    card: {
      ...
      todayTitle: "Read Big-O complexity in 5 minutes",
      comprehension: "72% understood",
      exampleLabel: "Worked example",
      exampleText: "A loop nested inside a loop, each running n times. With n = 1,000, how many steps does the code take?",
      priceLabel: "Input size",
      priceValue: "n = 1,000",
      epsValue: "1,000,000",
      peValue: "O(n²)",
      tip1: "O(n²) at n = 1,000 is already a million steps",
      tip2: "Comparing two algorithms only means something at the same input size",
      tip3: "Profile the code before rewriting it",
      metaLesson: "Lesson",
      ...
      quizQuestion: "Nested loops = O(n²)?",
      quizRight: "Correct: 1,000,000 steps",
      quizWrong: "Wrong: 2,000 steps",
      flashQuestion: "What is Big-O?",
      flashAnswer:
        "A way of describing how fast the step count grows as the data grows, ignoring constants.",
      noteLabel: "Sample note",
      noteTitle: "Don't optimise before you measure",
      noteBody: "Always ask: where is the code actually slow, and is n big enough to be worth it?",
      bullAlt: "The Silicon Valley bull - a Game Kingdom boss",
    },
    ...
    kingdom: {
      ...
      title: "A technology kingdom you unlock with knowledge",
      sub: "Game Kingdom turns studying into quests: finish lessons, take quizzes, play mini games and gradually unlock the buildings of the kingdom.",
    },
    ...
    vision: {
      ...
      title:
        "Vietnam's tech industry is growing fast, but the gap in the fundamentals is still very wide.",
      stat1Label: "Highly skilled",
      stat1Note: "of the workforce is highly skilled - Malaysia is at 29%.",
      stat2Label: "The gap",
    ...
    footer: {
      blurb:
        "A 100% free platform for teaching yourself technology: programming, data, AI and infrastructure. Helping Vietnamese people build a tech career through spaced repetition and Game Kingdom.",
  ...
  quizPage: {
    ...
    trackPersonal: "Tech foundations",
    trackPersonalDesc: "Computers, the command line, Git, a first language",
    trackProfessional: "Advanced technology",
    trackProfessionalDesc: "System architecture, databases, infrastructure, AI",
  ...
  worldBoss: {
    ...
    bossAlt: "The Silicon Valley bull, this week's boss",
    bossName: "The 3D Silicon Valley bull",
  ...
  worldMap: {
    levelShort: "Lv.{level}",
    empireTitle: "The Silicon Valley Empire",
    online: "Online",
    ...
    zoneCount: "12 TECHNOLOGY TERRITORIES",
  ...
  login: {
    ...
    subSignup: "Start your own technology learning journey in under a minute.",
  ...
  interview: {
    ...
    subtitle: "Practise technical + behavioural like a real engineering round",
    xpPerQuestion: "Reward +{xp} XP per correct answer",
    ...
    sourceBadge: "Source: the 400 technical interview questions",
    byRoleBody:
      "This question bank was written for software engineering roles, but the algorithms, data structures and system design sections apply to plenty of other technical roles. Pick a role to drill only the relevant parts.",
    ...
    drillBadge: "Built to the Silicon Valley \"400 Technical Questions\" standard",
    drillHeading: "Drill technical interviews like a real engineering round",
    drillBodyPart1: "A question bank compiled to the standard of the classic Silicon Valley guide ",
    drillBookTitle: "\"Cracking the Coding Interview\"",
    drillBodyPart2:
      ", spanning the whole range: data structures, algorithms, system design, databases and real-world debugging.",
    ...
    difficultyHint:
      "Tip: use \"Intermediate\" for a standard interview round, and \"Advanced\" when you want pressure practice before the onsite.",
    ...
    doneTitle: "Technical drill complete.",
    doneScore: "{score}/{total} correct",
    donePassed: " · Passed",
  ...
  ecosystem: {
    ...
    roadmapTitle: "Learn technology on a standardised, staged track",
    roadmapBody:
  ...
  resume: {
    ...
    quickGuideIntro:
      "\"Hello{name}! First time learning tech? Follow these 3 steps and you'll have a foundation right away.\"",
  ...
  kingdomPreview: {
    ...
    singaporeDescription:
      "Route data in and out, clear the queues that back up, and manage the cycle time of a real pipeline.",
    singaporeTag1: "Data pipelines",
    singaporeTag2: "Queues",
    singaporeTag3: "Throughput",
    pvpName: "The solo knowledge arena",
    pvpBadge: "SOLO PVP DUEL",
    pvpSubtitle: "Fight the boss with active-recall questions",
    pvpDescription:
      "Test your tech reflexes across rapid 1v1 quiz rounds and stack up XP.",
    pvpTag1: "Active recall",
    pvpTag2: "1v1 duels",
    pvpTag3: "{count}+ lesson quiz bank",

    q1: "Which of these is fastest on a server?",
    q1a: "Reading a variable already held in memory",
    q1b: "Reading a row from disk",
    q1c: "Calling an API in another datacenter",
    q1explanation:
      "Correct. Memory is thousands of times faster than disk, and millions of times faster than a network round trip.",
    q2: "What does a complexity of O(n log n) tell you?",
    q2a: "The step count grows a little faster than linearly as the data grows",
    q2b: "The algorithm always runs in exactly n log n seconds",
    q2c: "Memory use is always log n times the data",
    q2explanation:
      "Right. Big-O describes how fast the step count GROWS with input size, not an absolute time.",
  },
