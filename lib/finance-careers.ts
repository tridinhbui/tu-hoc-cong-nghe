...
export const FINANCE_CAREERS: FinanceCareer[] = [
  ...
  },
  {
    ...
    relatedLessonSlugs: ["modern-portfolio-theory", "bien-so-r-twr-mwrr", "rui-ro-la-gi", "rui-ro-danh-muc"],
  ...
  },
  {
    ...
    relatedLessonSlugs: ["lbo-model-co-che-co-ban", "due-diligence-quy-trinh-tham-dinh", "enterprise-value", "dinh-gia-tai-san-rong"],
  ...
  },
  {
    ...
    relatedLessonSlugs: ["no-tot-no-xau", "vay-mua-nha-co-ban", "kha-nang-chi-tra-mua-nha", "credit-rating"],
    relatedCfaSubjectIds: ["ethics"],
  ...
  },
  {
    ...
    relatedLessonSlugs: ["co-phieu-la-gi", "etf-la-gi", "dca", "tam-ly-dau-tu"],
