...
export const FINANCE_CAREERS: FinanceCareer[] = [
  ...
  },
  {
    ...
    relatedLessonSlugs: ["no-tot-no-xau", "vay-tien-giau-hay-pha-san", "don-bay-tai-chinh", "credit-rating", "rui-ro-vo-no"],
  ...
  },
  {
    ...
    relatedLessonSlugs: ["rui-ro-la-gi", "quan-ly-rui-ro-lai-suat-doanh-nghiep", "quan-ly-rui-ro-ty-gia-doanh-nghiep-xnk", "modern-portfolio-theory", "rui-ro-vo-no"],
  ...
  },
  {
    ...
    relatedLessonSlugs: ["treasury-management-quan-ly-dong-tien", "quan-ly-rui-ro-lai-suat-doanh-nghiep", "quan-ly-rui-ro-ty-gia-doanh-nghiep-xnk", "cau-truc-von-toi-uu-cho-doanh-nghiep", "case-xuat-khau-phong-ho-ty-gia"],
