...
export const lessonOverrides = {
  ...
  "chi-phi-vs-dong-tien-ra": patch({
    "quiz": [
    {
      ...
      "options": [
        "Dòng tiền 500tr, chi phí 100tr (500÷5)",
        "Dòng tiền 100tr, chi phí 100tr (chia đều cả hai)",
        "Dòng tiền 500tr, chi phí 500tr (ghi cả hai)",
        "Dòng tiền 100tr, chi phí 500tr (đảo ngược)"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Vì có chi phí phi tiền mặt như khấu hao trong P&L",
        "Vì Net Income tính theo tiền mặt, OCF theo dồn tích",
        "Vì hai chỉ tiêu này được tính trên hai kỳ khác nhau",
        "Vì OCF đã trừ thuế còn Net Income thì chưa trừ"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Có, thường gặp ở công ty đang mở rộng nhanh",
        "Không, hai chỉ tiêu phải luôn cùng dấu",
        "Có, nhưng chỉ ở doanh nghiệp nhà nước",
        "Không, đây luôn là dấu hiệu gian lận"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Dòng tiền: không thay đổi gì trong tháng đầu, Chi phí: ghi nhận ngay toàn bộ -12tr",
        "Dòng tiền: -1tr trong tháng đầu, Chi phí cũng chỉ ghi nhận -1tr tương ứng cùng tháng",
        "Dòng tiền: -12tr, Chi phí: -1tr (= 12tr ÷ 12 tháng)",
        "Dòng tiền: -12tr ngay lập tức, Chi phí cũng ghi nhận toàn bộ -12tr trong cùng tháng đó"
      ],
      "correct": 2,
    ...
    },
    {
      ...
      "options": [
        "Không, đó là phân bổ khoản đã chi từ trước",
        "Có, đó là tiền trả cho bên bán tài sản mỗi năm",
        "Có, doanh nghiệp trích tiền vào quỹ khấu hao",
        "Không, nhưng vẫn phải nộp thuế trên khoản đó"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Vì khấu hao là chi phí phi tiền mặt đã bị trừ",
        "Vì khấu hao là dòng tiền vào từ hoạt động đầu tư",
        "Vì khấu hao luôn được cơ quan thuế hoàn lại sau",
        "Vì chuẩn mực kế toán yêu cầu trình bày như vậy"
      ],
      "correct": 0,
  ...
  "tai-san-trong-ke-toan": patch({
    ...
    },
    {
      ...
      "options": [
        "Vì dự kiến bán hết trong vòng 1 năm",
        "Vì chuẩn mực xếp hàng hóa vào ngắn hạn",
        "Vì hàng tồn kho luôn có thể bán ngay",
        "Vì hàng tồn kho không phải khấu hao"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Tài sản dài hạn vô hình, amortize dần 5 năm",
        "Tài sản dài hạn hữu hình, khấu hao dần 5 năm",
        "Chi phí toàn bộ ngay trong năm mua bản quyền",
        "Tài sản ngắn hạn vì phần mềm hay bị thay thế"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Tài sản thực có hình thể vật lý, vô hình thì không",
        "Tài sản thực khấu hao, vô hình thì không khấu hao",
        "Tài sản thực là dài hạn, vô hình luôn là ngắn hạn",
        "Tài sản thực mua được, vô hình phải tự xây dựng"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Không chắc - còn tùy tài sản tăng nhờ vốn hay nợ",
        "Chắc chắn tốt vì quy mô doanh nghiệp đang lớn lên",
        "Chắc chắn xấu vì tài sản tăng kéo khấu hao tăng",
    ...
    },
    {
      ...
      "options": [
        "400 tỷ (500 − 100 khấu hao 10 năm)",
        "450 tỷ (khấu hao 10% một lần)",
        "100 tỷ (chỉ phần đã khấu hao)",
        "500 tỷ (nguyên giá không đổi)"
      ],
      "correct": 0,
    ...
    },
    {
      ...
      "options": [
        "Vì kế toán ghi chi phí lịch sử, bỏ qua vô hình tự tạo",
        "Vì giá cổ phiếu đã bao gồm cả cổ tức sẽ trả sau này",
        "Vì thị trường luôn định giá cao hơn giá trị thực tế",
        "Vì kế toán không ghi nhận hàng tồn kho theo giá bán"
      ],
      "correct": 0,
  ...
  "hang-ton-kho-la-gi": patch({
    "quiz": [
    {
      "question": "Báo cáo dòng tiền trả lời câu hỏi nào?",
      "options": [
        "Tiền thực tế vào ra bao nhiêu?",
        "Công ty đang nợ những ai và bao nhiêu?",
        "Công ty đang sở hữu những gì?",
        "Công ty lãi hay lỗ trong kỳ?"
      ],
      "correct": 0,
      "explanation": "Cash Flow cho biết tiền mặt thực tế vào và ra từ hoạt động, đầu tư, tài chính."
    },
    {
      "question": "Ba phần của báo cáo dòng tiền là:",
      "options": [
        "Operating, Investing, Financing",
        "Operating, Investing, Depreciation",
        "Revenue, Expenses, Net Income",
        "Assets, Liabilities, Equity"
      ],
      "correct": 0,
      "explanation": "CFO (Operating), CFI (Investing), CFF (Financing). Tổng cộng = Net change in cash."
    },
    {
      "question": "Operating Cash Flow bao gồm:",
      "options": [
        "Tiền từ hoạt động kinh doanh cốt lõi",
        "Tiền vay và tiền trả cổ tức cổ đông",
        "Toàn bộ tiền vào ra trong kỳ",
        "Tiền mua bán tài sản cố định"
      ],
      "correct": 0,
      "explanation": "OCF = tiền từ hoạt động kinh doanh, sau khi điều chỉnh chi phí phi tiền mặt."
    },
    {
      "question": "Investing Cash Flow bao gồm:",
      "options": [
        "Chi mua máy móc, bất động sản",
        "Tiền từ bán tài sản",
        "Cả hai",
        "Chi trả cổ tức"
      ],
      "correct": 2,
      "explanation": "CFI = tiền ra mua tài sản (CapEx) và tiền vào từ bán tài sản."
    },
    {
      "question": "Nếu công ty vay thêm 500 triệu, điều này ảnh hưởng đến phần nào của Cash Flow?",
      "options": [
        "Financing activities",
        "Operating activities (OCF)",
        "Không ảnh hưởng phần nào",
        "Investing activities"
      ],
      "correct": 0,
      "explanation": "Vay = thay đổi nợ = Financing activities."
    },
    {
      "question": "Tại sao OCF thường cao hơn Net Income?",
      "options": [
        "Vì khấu hao được cộng ngược trở lại",
        "Vì OCF chưa trừ thuế thu nhập doanh nghiệp",
        "Vì OCF đã gồm cả tiền vay mới trong kỳ",
        "Vì Net Income đã trừ cả chi phí đầu tư"
      ],
      "correct": 0,
      "explanation": "Công thức OCF = Net Income + Khấu hao - Thay đổi vốn lưu động. Khấu hao bị trừ khi tính lãi nhưng không phải tiền, nên cộng lại."
    },
    {
      "question": "Free Cash Flow = OCF - CapEx. Tại sao nhà đầu tư quan tâm?",
      "options": [
        "Vì đó là tiền còn lại để chia cổ tức hoặc trả nợ",
        "Vì đó là toàn bộ tiền mà công ty thu được trong kỳ",
        "Vì đó là con số ngân hàng dùng để tính lãi vay",
        "Vì đó là lợi nhuận kế toán sau khi trừ đầu tư"
      ],
      "correct": 0,
      "explanation": "FCF = tiền sẵn sàng cho chủ sở hữu (cổ tức, mua lại cổ phiếu) hoặc trả nợ."
    }
  ]
  }),
  "khoan-phai-thu-la-gi": patch({
    "quiz": [
    {
      "question": "Ratio (chỉ tiêu) trong phân tích tài chính là gì?",
      "options": [
        "Tỷ số giữa hai chỉ tiêu tài chính",
        "Con số tuyệt đối lấy từ báo cáo tài chính",
        "Chênh lệch giữa hai kỳ kế toán liền nhau",
        "Tỷ lệ phần trăm tăng trưởng qua các năm"
      ],
      "correct": 0,
      "explanation": "Ratios chuẩn hóa số liệu: Revenue 100 tỷ với 1.000 tỷ khác nhau, nhưng nếu chia cho mỗi đơn vị tài sản có thể so sánh."
    },
    {
      "question": "Current Ratio = Tài sản ngắn hạn / Nợ ngắn hạn. Mục đích là?",
      "options": [
        "Đo khả năng thanh toán ngắn hạn",
        "Đo khả năng trả nợ dài hạn của công ty",
        "Đo mức sinh lời trên tài sản ngắn hạn",
        "Đo tốc độ quay vòng của hàng tồn kho"
      ],
      "correct": 0,
      "explanation": "CR > 1 = công ty có đủ tài sản ngắn hạn để trả nợ ngắn hạn. CR < 1 = nguy hiểm."
    },
    {
      "question": "Quick Ratio (Acid-Test Ratio) khác Current Ratio ở chỗ?",
      "options": [
        "Quick Ratio loại trừ hàng tồn kho",
        "Quick Ratio cộng thêm tài sản cố định",
        "Quick Ratio loại trừ khoản phải thu",
        "Quick Ratio tính trên nợ dài hạn"
      ],
      "correct": 0,
      "explanation": "QR = (Current Assets - Inventory) / Current Liabilities. Nghiêm khắc hơn CR."
    },
    {
      "question": "Profit Margin (Gross, Operating, Net) dùng để?",
      "options": [
        "Đo lợi nhuận trên mỗi đồng doanh thu",
        "Đo tốc độ tăng doanh thu qua từng năm",
        "Đo lợi nhuận trên mỗi đồng tài sản",
        "Đo lợi nhuận trên mỗi đồng vốn chủ"
      ],
      "correct": 0,
      "explanation": "Margin = Lợi nhuận / Doanh thu. Cho biết công ty giữ được bao nhiêu % từ mỗi đô la bán ra."
    },
    {
      "question": "ROA = Net Income / Total Assets. Đo cái gì?",
      "options": [
      ...
      "correct": 0,
      "explanation": "ROA cao = công ty dùng tài sản hiệu quả, kiếm được nhiều lợi nhuận từ mỗi đơn vị tài sản."
    },
    {
      "question": "Debt-to-Assets Ratio cho biết?",
      "options": [
        "Bao nhiêu % tài sản được tài trợ bằng nợ",
        "Bao nhiêu lần tài sản lớn hơn vốn chủ",
        "Bao nhiêu % nợ đã thanh toán trong kỳ",
        "Bao nhiêu % lợi nhuận dùng trả lãi vay"
      ],
      "correct": 0,
      "explanation": "D/A = 50% = nửa tài sản từ nợ, nửa từ vốn chủ sở hữu."
    },
    {
      "question": "Khi so sánh hai công ty, tại sao phải dùng Ratio thay vì con số tuyệt đối?",
      "options": [
        "Vì Ratio chuẩn hóa được quy mô khác nhau",
        "Vì Ratio luôn chính xác hơn con số tuyệt đối",
        "Vì Ratio loại bỏ hoàn toàn yếu tố lạm phát",
        "Vì số tuyệt đối không có trên báo cáo"
      ],
      "correct": 0,
      "explanation": "Công ty A (1.000 tỷ) và B (100 tỷ) không thể so sánh trực tiếp. Nhưng ROA 15% vs 12% là có ý nghĩa."
    }
  ]
  }),
    ...
    "quiz": [
      {
        ...
        "options": [
          "Tiền thực tế vào ra bao nhiêu?",
          "Công ty đang nợ ai và bao nhiêu?",
          "Công ty lãi hay lỗ trong kỳ?",
          "Tài sản công ty gồm những gì?"
        ],
        "correct": 0,
        "explanation": "Cash Flow cho biết tiền mặt thực tế vào và ra từ hoạt động, đầu tư, tài chính."
      },
      ...
      },
      {
        "question": "Operating Cash Flow bao gồm:",
        "options": [
          "Tiền thu từ bán hàng và tiền trả chi phí vận hành",
          "Tiền nhận từ phát hành cổ phiếu và tiền trả cổ tức",
          "Tiền vay ngân hàng và tiền trả nợ gốc trong kỳ",
          "Tiền chi mua máy móc và nhà xưởng trong kỳ"
        ],
        "correct": 0,
        "explanation": "OCF = tiền từ hoạt động kinh doanh, sau khi điều chỉnh chi phí phi tiền mặt."
      },
      {
        "question": "Investing Cash Flow bao gồm:",
        "options": [
          "Tiền chi mua tài sản và tiền thu từ bán tài sản",
          "Tiền chi mua tài sản và tiền trả cổ tức cho cổ đông",
          "Tiền thu từ bán tài sản và tiền vay thêm ngân hàng",
          "Tiền chi mua hàng tồn kho và tiền thu từ bán hàng"
        ],
        "correct": 0,
        "explanation": "CFI = tiền ra mua tài sản (CapEx) và tiền vào từ bán tài sản."
      },
      {
        ...
        "options": [
          "Financing activities",
          "Chia đều cho Operating và Financing",
          "Investing activities",
      ...
      },
      {
        "question": "Tại sao OCF thường cao hơn Net Income?",
        "options": [
          "Vì khấu hao được cộng lại và vốn lưu động được điều chỉnh",
          "Vì OCF chưa trừ thuế thu nhập doanh nghiệp còn Net Income đã trừ",
          "Vì Net Income đã trừ cổ tức trả cho cổ đông còn OCF thì chưa trừ",
          "Vì OCF tính cả tiền vay ngân hàng còn Net Income thì không tính"
        ],
        "correct": 0,
        "explanation": "Công thức OCF = Net Income + Khấu hao - Thay đổi vốn lưu động. Khấu hao bị trừ khi tính lãi nhưng không phải tiền, nên cộng lại."
      },
      {
        "question": "Free Cash Flow = OCF - CapEx. Tại sao nhà đầu tư quan tâm?",
        "options": [
          "Vì nó cho biết tiền còn lại để trả cổ tức hoặc trả nợ",
          "Vì nó thay được lợi nhuận ròng khi tính chỉ số P/E của cổ phiếu",
          "Vì nó cho biết công ty đã đầu tư bao nhiêu vào tài sản cố định",
          "Vì nó là con số duy nhất không thể bị điều chỉnh bởi kế toán"
        ],
        "correct": 0,
        "explanation": "FCF = tiền sẵn sàng cho chủ sở hữu (cổ tức, mua lại cổ phiếu) hoặc trả nợ."
      }
