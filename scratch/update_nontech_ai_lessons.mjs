...
// Replace any existing lessons 1261..1270 in lib/lessons.ts
// We look for where `id: 1261` starts
const idx1261 = fileContent.indexOf('"id": 1261');
let targetStartIndex = idx1261;
if (idx1261 !== -1) {
  // back up to the opening brace of that object
...
const formattedLessonsStr = nonTechAiLessons.map(l => '  ' + JSON.stringify(l, null, 2)).join(',\n');
...
console.log('Successfully updated 10 Non-Tech Prompt Engineering AI lessons in lib/lessons.ts!');
